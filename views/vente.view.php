    ...
    <div class="bg-light shadow p-2">
        <div class="d-flex justify-content-between flex-wrap">
            ...
            <div class="col d-flex justify-content-end">
                <a href="<?= LINK ?>venteListe/" class="btn btn-primary">Historique des ventes <span class="mdi mdi-arrow-right-bold"></span></a>
            </div>
        </div>
    </div>
    <!-- FIN ENTETE -->
                    ...
                    <div class="responsive p-3">
                        <?php if (!empty($Cmde)) : ?>
                            <?php if (empty($_GET['id'])) : ?>
                                <input class="form-control p-4 border border-success" id="myInput" type="text" placeholder="Trouver rapidement l'article a vendre">
                                                        ...
                                                        <tr class="border-secondary">
                                                            ...
                                                            <form action="" method="POST">
                                                                <td style="width: 100px;">
                                                                    <input type="number" class="form-control border-secondary" name="Quantite_vendu" min="1" max="<?= $data['Quantite_produit'] ?>" step="0" placeholder="Ex:5" id="" required>
                                                                </td>
                        ...
                        <?php else : ?>
                            <div class="text-center">
                                <span class="mdi mdi-arrow-down-bold" style="font-size: 100px;"></span>
                                <hr>
                                <form action="" method="post">
                                    <button type="submit" name="new-commande" class="btn btn-outline-info p-3">Commancer une nouvelle commande ?</button>
                                </form>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-4 border-dark">
                    <div class="responsive-design-ui p-1">
                                            ...
                                            <?php if (!empty($ALL_FACTURE_EN_COURS)) : ?>
                                                <tr class="m-0 p-0">
                                                    ...
                                                    <td class="text-danger">
                                                        <?php if (empty($_GET['id'])) : ?>
                                                            <form action="" method="post">
                                                                <input type="number" name="Remise" min="1" max="5" placeholder=" %" id="">
                                                            </form>
                                                        <?php else : ?>
                                                            <input type="number" min="1" max="100" placeholder=" %" disabled id="">
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                            ...
                            <div class="card p-3">
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    <div class="col m-0 p-0">
                                        <th class="border-0">
                                            <a href="<?= LINK ?>vente/" class="btn btn-outline-danger"> <span class="mdi mdi-reply"></span> Back</a>
                                        </th>
                                    </div>
                        ...
                        <?php else : ?>
                            <?php if (!empty($Cmde[1])) : ?>
                                <th class="border-0">
                                    <a href="<?= LINK ?>vente/<?= $Cmde[1] ?>" class="btn btn-outline-info w-100" name="poursuivre_cmd">Poursuivre <span class="mdi mdi-arrow-right"></span></a>
                                </th>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
